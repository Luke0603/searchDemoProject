...
//        self.window!.makeKeyAndVisible()
    ...
    func setTabbar() -> UITabBarController {
        ...
        let nvSearch = UINavigationController(rootViewController: searchVC)
        
        let nvFavorite = UINavigationController(rootViewController: favoriteVC)

        tabbarcntrl.viewControllers = [nvSearch, nvFavorite]
        
        let tabHome = tabbarcntrl.tabBar.items![0]
        tabHome.title = "Search"
...
//    }
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "searchDemoProject")
